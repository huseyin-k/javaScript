...
console.log(items[0].length)// Array icindeki istedigimiz Arrayın length bilgisini aldik
...
let allUsers = [...femaleUsers, ...maleUsers]// es6  birden fazla array yapısını birlestirme

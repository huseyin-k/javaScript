...
const alertFunction = (title, message, className ="success") =>  `
...
function formHandler(event){
    ...
    if(USER_NAME.value && SCORE.value) {
        addItem(USER_NAME.value, SCORE.value) //gonderkdikten sonra sıfırladık
        USER_NAME.value =""
        SCORE.value = ""
    }else{
        alertDOM.innerHTML = alertFunction("Baslik Bilgisi",

...
//Now, God only knows
let y = 1;  // bu dogru kullanim degil :(
...
// 2: Line Length < 80
//let fullname ="ahmet"  yanlış kullanım :)

//let kodlauyoruzserverinfo ="" yanlış kullanım :)
//let kodluyooruz_server_info ="" yanlış kullanım :)
//let fullName ="" yanlış kullanım :)
//let KodluyoruzServerInfo ="" Doğru kullanım :))
//let kodluyoruzSErverInfo ="" yanlış kulalnım :)


//const password = "1234"  yanlış kullanım :)
//const PASSWORD = "12345" doğru kullanım :))
const PASSWORD_SERVER = "1234" // doğru kullanım :))


let x = 1; // yanlış kullanım :)